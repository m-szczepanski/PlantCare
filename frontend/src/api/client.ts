import type { CareTask, CareTaskType, Dashboard, ImportResult, Insights, JournalEntry, Plant, PlantInput, PlantNote, PlantProfile, PlantProfileInput, PlantProfileOption, Room, RoomInput, SoilMixOption, SoilTypeOption, StatusInfo, WaterDetails, WateringLogEntry } from "./types";
