...
GET    /api/reference-data/soil-types   pickable soil types with their watering-permeability factors and the known substrate blends offered as picker presets (drives the plant-form picker and live preview)
